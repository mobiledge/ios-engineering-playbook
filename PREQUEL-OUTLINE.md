...
revised Playbook's `code/part-2-modular/ch01` are the same app —

```bash
diff -r code/part-1-architecture/ch10-project-hygiene code/part-2-modular/ch01-the-monolith   # → empty (after the Playbook revision)
```
