...
The music screen lives in `Sources/Features/Music/`, reusable components in `Sources/DesignSystem/`;
API responses decode into `Sources/Models/`, and the network lives in `Sources/Networking/` behind
